...
export const TablaBebidas = () => {
    ...
    const fetcher = async () => {
        const Response = await axios.get("http://localhost:5000/products/getBeverages");
        ...
        <>
            <div className="overflow-x mx-8 w-full">
                <div className="py-2 inline-block min-w-full sm:px-6 lg:px-8 mx-auto"> {/* Modificación aquí */}
                    ...
                    <h1 className="border-[#58764E] border-b-4 p-2 w-[40%] text-5xl my-8 font-bold text-[#F47228]" >Gestionar bebidas</h1>
